...
//                                 <th scope='col' className='w-[15%]'>mobile number</th>
                    ...
                    <table className='w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                        ...
                        <tbody>
                            ...
                            <tr className='bg-white border-gray-200 hover:bg-gray-50'>
                                ...
                                <td>9876543210</td>
                                <td>
                                    <button className='bg-green-500 py-1.5 text-white font-semibold px-5 rounded-sm'>Active</button>
                                </td>
                                <td>
                            ...
                            <tr className='bg-white border-gray-200 hover:bg-gray-50'>
                                ...
                                <td>9876543210</td>
                                <td>
                                    <button className='bg-red-500 py-1.5 text-white font-semibold px-5 rounded-sm'>Deactive</button>
                                </td>
                                <td>
                                    <button className='flex justify-center items-center text-white bg-blue-500 w-[40px] h-[40px] rounded-full'>
                                        <MdEdit className='text-[18px]' />
